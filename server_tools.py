""" server_tools.py 
    ...
    Program with tools requires for the server side of 
    our IoT plant monitoring solution. Deals with the
    saved information log in our own format to produce
    averages minimums and maximums for different values.
"""
